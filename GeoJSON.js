var GeoJSON = function( geojson, options ){
	...
	var _geometryToGoogleMaps = function( geojsonGeometry, opts, geojsonProperties ){
		...
		switch ( geojsonGeometry.type ){
			case "Point":
				...
				if (geojsonGeometry.name) {
				  opts.title = geojsonGeometry.name;
				}
	...
	switch ( geojson.type ){
		...
		case "Point": case "MultiPoint": case "Circle": case "LineString": case "MultiLineString": case "Polygon": case "MultiPolygon":
